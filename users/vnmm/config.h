...
#ifndef BLUETOOTH_PROFILE_INDICATOR_COLOR
// If bluetooth is enabled, the key on the fn layer that toggles it will light up this color
#    define BLUETOOTH_PROFILE_INDICATOR_COLOR RGB_BLUE
#endif
...
#define PAIRING_COLOR RGB_BLUE

#define POWER_BELOW_30_INDICATOR_COLOR RGB_RED
#define POWER_BETWEEN_30_70_INDICATOR_COLOR RGB_YELLOW
#define POWER_ABOVE_70_INDICATOR_COLOR RGB_GREEN
