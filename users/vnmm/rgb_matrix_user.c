...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    ...
    switch (current_layer) {
        ...
        case MAC_BASE:
            ...
            if (power_below_30) {
                rgb_matrix_set_color_by_keycode(led_min, led_max, current_layer, is_shift_indicator, POWER_BELOW_30_INDICATOR_COLOR);
                rgb_matrix_set_color_by_keycode(led_min, led_max, current_layer, is_caps_lock_indicator, POWER_BELOW_30_INDICATOR_COLOR);
            }
#endif
...
#endif
#ifdef BLUETOOTH_ENABLE
            rgb_matrix_set_color_by_keycode(led_min, led_max, current_layer, is_bt_profile_indicator, BLUETOOTH_PROFILE_INDICATOR_COLOR);
#endif
            if (pairing) {
                rgb_matrix_set_color_by_not_keycode(led_min, led_max, current_layer, is_transparent, PAIRING_COLOR);
            } else if (power_below_30) {
                rgb_matrix_set_color_by_not_keycode(led_min, led_max, current_layer, is_transparent, POWER_BELOW_30_INDICATOR_COLOR);
            } else if (power_between_30_70) {
#ifdef POWER_BETWEEN_30_70_INDICATOR_COLOR
                rgb_matrix_set_color_by_not_keycode(led_min, led_max, current_layer, is_transparent, POWER_BETWEEN_30_70_INDICATOR_COLOR);
#endif
            } else if (power_above_70) {
#ifdef POWER_ABOVE_70_INDICATOR_COLOR
                rgb_matrix_set_color_by_not_keycode(led_min, led_max, current_layer, is_transparent, POWER_ABOVE_70_INDICATOR_COLOR);
#endif
            }
